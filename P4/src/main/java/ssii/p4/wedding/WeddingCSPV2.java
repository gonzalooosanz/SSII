 ...
 */
public class  WeddingCSPV2 extends CSP implements Serializable {
	...
	public WeddingCSPV2() {
		...
		addConstraint(new PairsInTableOrNone("m7","h7",tables.get("table1")));
		addConstraint(new PairsInTableOrNone("m7","h7",tables.get("table2")));
		addConstraint(new PairsInTableOrNone("m7","h7",tables.get("table3")));
		
		addConstraint(new PairsInTableOrNone("m2","h2",tables.get("table1")));
		addConstraint(new PairsInTableOrNone("m2","h2",tables.get("table2")));
		addConstraint(new PairsInTableOrNone("m2","h2",tables.get("table3")));
		
		
		addConstraint(new PairsInTableOrNone("m3","h3",tables.get("table1")));
		addConstraint(new PairsInTableOrNone("m3","h3",tables.get("table2")));
		addConstraint(new PairsInTableOrNone("m3","h3",tables.get("table3")));
		
		addConstraint(new PairsInTableOrNone("m4","h4",tables.get("table1")));
		addConstraint(new PairsInTableOrNone("m4","h4",tables.get("table2")));
		addConstraint(new PairsInTableOrNone("m4","h4",tables.get("table3")));
		
		addConstraint(new PairsInTableOrNone("m5","h5",tables.get("table1")));
		addConstraint(new PairsInTableOrNone("m5","h5",tables.get("table2")));
		addConstraint(new PairsInTableOrNone("m5","h5",tables.get("table3")));
	...
	public static void main(String[] args) {
		WeddingCSPV2 csp = new WeddingCSPV2();
