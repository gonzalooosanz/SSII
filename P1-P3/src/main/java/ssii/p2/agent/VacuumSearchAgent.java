...
import ssii.p1.agent.VacuumGoalCompetingAgentsTest;
...
public class VacuumSearchAgent extends SimpleProblemSolvingAgent {
	VacuumState ms=new VacuumState( 
	...
	protected Problem formulateProblem(Object goal) {	 		 	
		ActionsFunction actionsFunction = new VacuumActionsFunction(this.hashCode());

		ResultFunction resultFunction = new VacuumResultFunction();

		GoalTest goalTest = new VacuumGoalCompetingAgentsTest(this.hashCode());		
